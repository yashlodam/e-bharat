...
function Testimonial() {
    ...
    return (
      ...
      "This is the best e-commerce store I've ever used. The products are high-quality, and the customer service is outstanding. Fast shipping too!".</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  style={{color: mode === 'dark' ? 'white' : ''}}className="leading-relaxed">"The best part is how easy the website is to use. The filters actually work, and the product descriptions are detailed. No frustrating search process, just quick shopping."</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="leading-relaxed">"As a developer, I appreciate sites built with true scalability. The consistent UI across every page—from the filtering components to the checkout flow—proves they are using a robust React-based Design System."</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 style={{color: mode === 'dark' ? '#ff4162' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">React Js</h2>
